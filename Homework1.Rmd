...
The following plots show the distribution across samples of the gene expression level of the ribosomal protein L37a gene.
TODO: add comments
...
The following plots show the distribution across samples of the gene expression level of the 8-oxoguanine DNA glycoslyase gene.
TODO: add comments
...
# Volcano plot has log2(fold change) on x-axis and -log10(adj p value) on y-axis
volcano_plot <- array-data %>%
...
```{r ma, warning=FALSE}
# MA plot has avg. expression signal on x-axis and log2(fold change) on y-axis
```
